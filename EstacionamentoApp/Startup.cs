...
namespace EstacionamentoApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            #region Repositories
            services.AddScoped(typeof(IRepositoryRegistro), typeof(RepositoryRegistro));
            services.AddScoped(typeof(IRepositoryVigencia), typeof(RepositoryVigencia));
            #endregion

            #region Services
            services.AddScoped(typeof(IRegistroService), typeof(RegistroService));
            services.AddScoped(typeof(IVigenciaService), typeof(VigenciaService));
            #endregion
        }
